...
nxpl=int_best((xlim20-xlim1)/dxpl)
nypl=int_best((ylim20-ylim1)/dypl)

xlim2=xlim1+nxpl*dxpl
ylim2=ylim1+nypl*dypl
...
open(11,file='../../../TMP_files/tmp/matr'//it//gr//'.dat',form='unformatted')
    ...
    !        end do
            do i8=1,8
                ...
                if(abs(xnod8(3)-xnod8(1)).lt.0.00001)then
                    ...
                    ' kall_xy(ix21,nur1,1,ips)',kall_xy(ix21,nur1,1,ips)
                ...
                !write(*,*)' i8=',i8,' knod8(i8)=',knod8(i8),' dtdv=',dtdv
                !write(*,*)
            end do
            !pause
        end do
