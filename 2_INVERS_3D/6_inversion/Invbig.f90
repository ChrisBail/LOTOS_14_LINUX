...
open(3,file='../../../TMP_files/tmp/matr'//it//gr//'.dat',form='unformatted')
...
if(nrps(1).ne.0) then
    open(1,file='../../../DATA/'//ar//'/'//md//'/data/link_hor1'//gr//'.dat',form='unformatted')
    read(1)link_hor_p
    write(*,*)' link_hor_p=',link_hor_p
    close(1)
    open(1,file='../../../DATA/'//ar//'/'//md//'/data/link_ver1'//gr//'.dat',form='unformatted')
    read(1)link_ver_p
...
if(nrps(2).ne.0) then
    open(1,file='../../../DATA/'//ar//'/'//md//'/data/link_hor2'//gr//'.dat',form='unformatted')
    read(1)link_hor_s
    write(*,*)' link_hor_s=',link_hor_s
    close(1)
    open(1,file='../../../DATA/'//ar//'/'//md//'/data/link_ver2'//gr//'.dat',form='unformatted')
    read(1)link_ver_s
